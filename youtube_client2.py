...
if __name__ == "__main__":
  ...
  videoId = 'dO0GfRWQTT4'
  # argparser.add_argument(videoId=videoId, required=True,
  #   help="ID of video whose thumbnail you're updating.")

  # The "file" option specifies the path to the thumbnail image file.
  final_imag = 'C:/Users/anton\Desktop\Projetos\Python\Video 4 app 0.1\images/thumb/final_thumbnail.png'
  # argparser.add_argument(file=final_imag, required=True,
  ...
  try:
    ...
    upload_thumbnail(youtube, videoId, final_imag)
